...
public class SolarSystemPanel extends JPanel {
    ...
    public SolarSystemPanel() {
        celestialBodies = new CelestialBody[] {
                ...
                new CelestialBody(0, 0, CelestialConstants.Europa.RADIUS, CelestialConstants.Europa.COLOR, CelestialConstants.Europa.DISTANCE_FROM_PARENT, CelestialConstants.Europa.NAME, CelestialConstants.Europa.ORBITAL_SPEED, jupiter,ImagePaths.europaImage),
