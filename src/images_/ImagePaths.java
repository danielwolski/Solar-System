...
public class ImagePaths {
    ...
    public static final String sunImage = pathBeg + "\\sun.png";
    public static final String jupiterImage = pathBeg + "\\jupiter.png";
    public static final String saturnImage = pathBeg + "\\saturn.png";
    public static final String uranusImage = pathBeg + "\\uranus.png";
